...
class EventEdit extends StatefulWidget {
  static const String routeName = "/EventEdit";
...
class _EventEditState extends State<EventEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!exist) {
      ...
      selectedDate = DateTime.fromMicrosecondsSinceEpoch(info.date);
      selectedTime = TimeOfDay.fromDateTime(
        DateTime.fromMicrosecondsSinceEpoch(info.time),
      );
                ...
                children: [
                  ...
                  FilledButton(
                    onPressed: () async {
                      ...
                      try {
                         EventsDM updateEvent = EventsDM(
                           ...
                           favouriteUser: info.favouriteUser,
                        );
                         await EventDataBase().updateEvent(updateEvent);
                         if(!mounted) return;
                        Navigator.pop(context);
                        AppDialogs.showActionDialog(
                          context,
                          title: locale.successOperation,
                          content: locale.eventUpdateSuccessfully,
                    ...
                    child: Row(
                      ...
                      children: [Text(locale.updateEvent)],
                    ),
                  ),
                ],
              ),
